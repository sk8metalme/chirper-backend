...
- [ ] 5.2 (P) ITweetRepository Interface定義
...
- [ ] 8.3 (P) FollowRepositoryImpl実装
  - IFollowRepositoryを実装し、フォローユーザーID取得ロジックを実装
  - _Requirements: 7.4, 7.7_

- [ ] 8.4 (P) LikeRepositoryImpl実装
  - ILikeRepositoryを実装し、いいね済み状態判定ロジックを実装
  - _Requirements: 7.4, 7.7_

- [ ] 8.5 (P) RetweetRepositoryImpl実装
